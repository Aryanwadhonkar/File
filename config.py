...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7709318237:AAE9gL7l7V9Q0ZUSUGO0XfmoS5JDMi6Km-c")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002690195301"))
...
#start message
START_PIC = os.environ.get("START_PIC","https://pasteboard.co/8SaF7Tr8rUAH.jpg")
